...
export default function ContactSection() {
  ...
  return (
    <section
      className="relative bg-gradient-to-br from-gray-900 via-gray-900 to-gray-950 py-20 overflow-hidden"
      id="contact_section"
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white bg-clip-text text-transparent bg-gradient-to-r from-blue-400 via-indigo-400 to-purple-400">
            Get In Touch
          </h2>
            ...
            <div className="lg:w-2/5 bg-gradient-to-br from-blue-900/20 via-indigo-900/20 to-purple-900/20 p-8 lg:p-12">
              <div className="h-full flex flex-col">
                ...
                <p className="text-gray-300 mb-8">
                  Ready to start your next project? Reach out through any of
                  these channels.
                </p>
                    ...
                    <div className="p-4">
                      ...
                      <form onSubmit={handleSubmit}>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-3 rounded-lg bg-gray-700/50 border ${
                                validationErrors.name
                                  ? "border-red-500"
                                  : "border-gray-600"
                              } focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 text-white placeholder-gray-400 outline-none transition`}
                            />
                            {validationErrors.name && (
                          ...
                          <textarea
                            ...
                            className={`w-full px-4 py-3 rounded-lg bg-gray-700/50 border ${
                              validationErrors.message
                                ? "border-red-500"
                                : "border-gray-600"
                            } focus:border-blue-500 focus:ring-2 focus:ring-blue-500/30 text-white placeholder-gray-400 outline-none transition resize-none`}
                          ></textarea>
                          {validationErrors.message && (
                            <p className="text-red-400 text-sm mt-1">
                              {validationErrors.message}
                        ...
                        <button
                          ...
                          className={`w-full px-8 py-3 rounded-lg bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium flex items-center justify-center transition
                          ${
                            isSubmitting
                              ? "opacity-80 cursor-not-allowed"
                              : "hover:from-blue-700 hover:to-indigo-700 shadow-lg shadow-blue-600/30 hover:shadow-blue-700/40"
                          }`}
                        >
                          {isSubmitting ? (
                            <>
